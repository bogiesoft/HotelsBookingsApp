...
public class Addhr44per extends Activity {
...
void onload(){
    setContentView(R.layout.addhr44per);

    MyListV=(ListView)findViewById(R.id.addr44perlv);
    isempty=(TextView)findViewById(R.id.addr44p_empty);

    addbtn= (Button) findViewById(R.id.addr44p_add);
    delbtn=(Button)findViewById(R.id.addr44p_del);
    savebtn=(Button)findViewById(R.id.addr44p_save);
...
//        final Dialog dialog = new Dialog(Addhr44per.this);
...
//                }
//                if(roomprice<=0)
//                    new AlertDialog.Builder(Addhr44per.this)
//                            .setTitle("Oops !")
...
//        dialog.show();
    ...
    savebtn.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            progressDialog = ProgressDialog.show(Addhr44per.this, "",
                    "Loading. Please wait...", true);

            for(int i=0;i<list.size();i++)
                add1room44per(list.get(i));
            progressDialog.dismiss();
            finish();
        }
    });
}
    private void add1room44per(final String num){
