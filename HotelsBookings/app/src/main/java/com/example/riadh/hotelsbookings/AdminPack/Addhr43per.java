...
public class Addhr43per extends Activity {
...
void onload(){
    setContentView(R.layout.addhr43per);

    MyListV=(ListView)findViewById(R.id.addr43perlv);
    isempty=(TextView)findViewById(R.id.addr43p_empty);

    addbtn= (Button) findViewById(R.id.addr43p_add);
    delbtn=(Button)findViewById(R.id.addr43p_del);
    savebtn=(Button)findViewById(R.id.addr43p_save);
...
//        final Dialog dialog = new Dialog(Addhr43per.this);
...
//                }
//                if(roomprice<=0)
//                    new AlertDialog.Builder(Addhr43per.this)
//                            .setTitle("Oops !")
...
//        dialog.show();
    ...
    savebtn.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            progressDialog = ProgressDialog.show(Addhr43per.this, "",
                    "Loading. Please wait...", true);

            for(int i=0;i<list.size();i++)
                add1room43per(list.get(i));
    ...
    private void add1room43per(final String num){
